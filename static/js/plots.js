d3.json('https://gvinusa.herokuapp.com/data.json',(error,data) =>{
  ...
  var layer_2014_death=buildLayer(data_2014,"n_killed");
  var layer_2015_death=buildLayer(data_2015,"n_killed");
  var layer_2016_death=buildLayer(data_2016,"n_killed");
  var layer_2017_death=buildLayer(data_2017,"n_killed");

  var layer_2014_injured=buildLayer(data_2014,"n_injured");
  var layer_2015_injured=buildLayer(data_2015,"n_injured");
  var layer_2016_injured=buildLayer(data_2016,"n_injured");
  var layer_2017_injured=buildLayer(data_2017,"n_injured");
  ...
  var baseMaps = {
    "2014 Deaths": layer_2014_death,
    "2015 Deaths": layer_2015_death,
    "2016 Deaths":layer_2016_death,
    "2017 Deaths":layer_2017_death,
    "2014 Injured": layer_2014_injured,
    "2015 Injured": layer_2015_injured,
    "2016 Injured":layer_2016_injured,
    "2017 Injured":layer_2017_injured
};
...
L.control.layers(baseMaps, null).addTo(map);
  ...
  legend_killed.onAdd = function() {
    ...
    var grades = [0, 20, 50, 85, 150, 250, 500, 1000];
        ...
        datasets: [
          {
            ...
            data: data.map((obj)=>{return obj.n_killed})
          },
          {
            label: 'Gun injuries',
            backgroundColor: 'rgb(54, 162, 235)',
            borderColor: 'rgb(54, 162, 235)',
            data:  data.map((obj)=>{return obj.n_injured})
          }
        ]
    },
...
//set style for the injured
function style_injuired(feature) {

  return {
      fillColor: getColor(feature.properties.n_injured),
      weight: 2,
      opacity: 1,
      color: 'white',
      dashArray: '3',
